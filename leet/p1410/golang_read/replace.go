...
//makeGenericReplacer if old is not single character
//if all new is single character, create byteReplacer
//if any new is longer than single charactor, create a byteStringReplacer
